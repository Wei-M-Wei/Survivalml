...
This is the first version of the R package 'Survivalml'. Please note that the package itself does not include the raw dataset used in the empirical section. The dataset is available in 'reproduce package'.
...
The empirical scripts use `period_final_new6.csv`,
`period_final_new10.csv`, and, for macro-augmented specifications,
`process.xls`. The simulation and empirical scripts can be computationally
