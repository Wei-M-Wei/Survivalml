...
This is the first version of the R package 'Survivalml'. Please note that the package itself does not include the raw dataset used in the empirical section. The dataset is available in 'reproduce'.
