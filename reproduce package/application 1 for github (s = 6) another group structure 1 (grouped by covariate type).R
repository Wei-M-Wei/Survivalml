# Script: application 1 for github (s = 6) another group structure 1 (grouped by covariate type).R
# Corporate Survival Analysis with Machine Learning Methods
# Purpose: Reproduce Application 1 for s = 6 using groups defined by covariate type.
#============================================================
