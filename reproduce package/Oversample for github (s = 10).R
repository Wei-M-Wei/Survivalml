# Script: Oversample for github (s = 10).R
# Corporate Survival Analysis with Machine Learning Methods
# Purpose: Reproduce the oversampling results for s = 10.
#============================================================
...
# Prediction horizons t = 13, 13.5, and 14 years: Estimator (5) in the paper
