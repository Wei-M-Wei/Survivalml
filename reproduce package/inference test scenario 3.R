# Script: inference test scenario 3.R
# Corporate Survival Analysis with Machine Learning Methods
# Purpose: Evaluate inference size under simulation scenario 3.
#============================================================


#============================================================
# Run the scenario-3 inference size simulation
#============================================================
...
print(pa[i, ])
table_name <- paste0("MIDASAUC_scenario3_inference_rejection", censor, 1200, s,  ".csv")
