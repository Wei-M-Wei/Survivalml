# Script: Simulation scenario 3 revised.R
# Corporate Survival Analysis with Machine Learning Methods
# Purpose: Run prediction simulation scenario 3.
#============================================================
...
for (censor in censor_strength){
  ...
  table_name <- paste0("MIDASAUC_scenario3_revised", censor, 800, s,  ".csv")
...
for (censor in censor_strength){
  ...
  table_name <- paste0("MIDASAUC_scenario3_revised", censor, 1200, s,  ".csv")
  write.table(pa, table_name, sep = ";", row.names = FALSE, quote = FALSE)
}
