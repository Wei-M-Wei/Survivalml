# Script: inference test scenario 2 power.R
# Corporate Survival Analysis with Machine Learning Methods
# Purpose: Evaluate inference power under simulation scenario 2.
#============================================================


#============================================================
# Run the scenario-2 inference power simulation
#============================================================
...
# Extract the inference metrics for scenario 2
...
# Calculate the censoring rate for a simulated scenario-2 dataset
...
print(pa[i, ])
table_name <- paste0("MIDASAUC_scenario2_inference_power", censor, 1200, s,  ".csv")
