# Script: inference test scenario 5.R
# Corporate Survival Analysis with Machine Learning Methods
# Purpose: Evaluate inference size under simulation scenario 5.
#============================================================


#============================================================
# Run the scenario-5 inference size simulation
#============================================================
...
# Extract the inference metrics for scenario 5
...
# Calculate the censoring rate for a simulated scenario-5 dataset
...
# Scenario 5: N = 800
  ...
  print(pa[i, ])
  table_name <- paste0("MIDASAUC_scenario5_inference_rejection", censor, 1200, s,  ".csv")
