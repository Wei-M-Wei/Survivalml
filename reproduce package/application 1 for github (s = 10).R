# Script: application 1 for github (s = 10).R
# Corporate Survival Analysis with Machine Learning Methods
# Purpose: Reproduce the main Application 1 results for s = 10.
#============================================================
...
t = 13
# Part 1
# Prediction horizons t = 13, 13.5, and 14 years: Estimator (5) in the paper (SGL-MIDAS, LASSO-MIDAS, and LASSO-UMIDAS)
...
# Part 2
# Prediction horizons t = 13, 13.5, and 14 years: comparison model without censoring
for (t in c( 13, 13.5, 14)) {
  # Number of iterations
  it = 10
  result_para = foreach(k = 1:it, .errorhandling= 'remove', .packages = packages_to_export, .export = export_env) %dopar% {
