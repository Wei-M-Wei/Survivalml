# Script: application 1 for github (s = 10) another group structure 2 ((grouped by correlation matrix)).R
# Corporate Survival Analysis with Machine Learning Methods
# Purpose: Reproduce Application 1 for s = 10 using groups defined by the correlation matrix.
#============================================================


#============================================================
# Reproduce Application 1 for s = 10 years and t = 13, 13.5, and 14 years
#============================================================
