# Script: SNR LASSOU scenario 5.R
# Corporate Survival Analysis with Machine Learning Methods
# Purpose: Run the LASSO-U signal-to-noise-ratio simulation for scenario 5.
#============================================================
...
for (censor in censor_strength){
  ...
  table_name <- paste0("LASSOUMIDAS_scenario5_SNR", censor, 800, s,  ".csv")
