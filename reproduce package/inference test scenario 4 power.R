# Script: inference test scenario 4 power.R
# Corporate Survival Analysis with Machine Learning Methods
# Purpose: Evaluate inference power under simulation scenario 4.
#============================================================


#============================================================
# Run the scenario-4 inference power simulation
#============================================================
...
generateData_AR <-
  function(s, n, numhv, numtrue, degree, jmax, parameters = NA, censor_strength){
    ...
    # Extract the inference metrics for scenario 4
    ...
    # Calculate the censoring rate for a simulated scenario-4 dataset
    ...
    print(pa[i, ])
    table_name <- paste0("MIDASAUC_scenario4_inference_power", censor, 1200, s,  ".csv")
