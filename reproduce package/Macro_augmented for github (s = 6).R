# Script: Macro_augmented for github (s = 6).R
# Corporate Survival Analysis with Machine Learning Methods
# Purpose: Reproduce the macro-augmented empirical results for s = 6.
#============================================================
...
# Prediction horizons t = 8, 8.5, and 9 years
for (t in c( 8, 8.5, 9)) {
  ...
  table_name4 <- paste0("Macro_MIDAS_bootstrap", s, "_AUC", t, ".csv")
  table_name5 <- paste0("Macro_MIDAS", s, "_cof", t, ".csv")
  table_name6 <- paste0("Macro_MIDAS", s, "_cof_AUC", t, ".csv")
  table_name7 <- paste0("Macro_MIDAS_LASSO", s, "_cof", t, ".csv")
  table_name8 <- paste0("Macro_MIDAS_LASSO", s, "_cof_AUC", t, ".csv")
  table_name9 <- paste0("Macro_LASSO", s, "_cof", t, ".csv")
  table_name10 <- paste0("Macro_LASSO", s, "_cof_AUC", t, ".csv")
