# Script: inference test scenario 2.R
# Corporate Survival Analysis with Machine Learning Methods
# Purpose: Evaluate inference size under simulation scenario 2.
#============================================================


#============================================================
# Run the scenario-2 inference size simulation
#============================================================
...
print(pa[i, ])
table_name <- paste0("MIDASAUC_scenario2_inference_rejection", censor, 1200, s,  ".csv")
