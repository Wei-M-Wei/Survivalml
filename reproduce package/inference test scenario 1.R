# Script: inference test scenario 1.R
# Corporate Survival Analysis with Machine Learning Methods
# Purpose: Evaluate inference size under simulation scenario 1.
#============================================================


#============================================================
# Run the scenario-1 inference size simulation
#============================================================
...
print(pa[i, ])
table_name <- paste0("MIDASAUC_scenario1_inference_rejection", censor, 1200, s,  ".csv")
