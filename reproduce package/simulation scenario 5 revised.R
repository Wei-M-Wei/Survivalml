# Script: simulation scenario 5 revised.R
# Corporate Survival Analysis with Machine Learning Methods
# Purpose: Run prediction simulation scenario 5.
#============================================================


#============================================================
# Reproduce simulation scenario 5
#============================================================
...
for (censor in censor_strength){
  ...
  table_name <- paste0("MIDASAUC_scenario5_revised", censor, 800, s,  ".csv")
...
for (censor in censor_strength){
  ...
  table_name <- paste0("MIDASAUC_scenario5_revised", censor, 1200, s,  ".csv")
  write.table(pa, table_name, sep = ";", row.names = FALSE, quote = FALSE)
}
