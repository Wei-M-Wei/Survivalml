# Script: application 1 for github (s = 10) another group structure 1 ((grouped by covariate type)).R
# Corporate Survival Analysis with Machine Learning Methods
# Purpose: Reproduce Application 1 for s = 10 using groups defined by covariate type.
#============================================================
...
##############################################################
  ...
  for (t in c( 13, 13.5, 14)) {
    ...
    # Save the table
    table_name1 <- paste0("type_another_G_MIDAS_AUC", s, "_AUC_cvm", t, ".csv")
    table_name2 <- paste0("type_another_G_MIDAS_AUC", s, "_AUC", t, ".csv")
    table_name3 <- paste0("type_another_G_MIDAS_bootstrap", s, "_AUC_cvm", t, ".csv")
    table_name4 <- paste0("type_another_G_MIDAS_bootstrap", s, "_AUC", t, ".csv")
    table_name5 <- paste0("type_another_G_MIDAS", s, "_cof", t, ".csv")
    table_name6 <- paste0("type_another_G_MIDAS", s, "_cof_AUC", t, ".csv")
    table_name7 <- paste0("type_another_G_MIDAS_LASSO", s, "_cof", t, ".csv")
    table_name8 <- paste0("type_another_G_MIDAS_LASSO", s, "_cof_AUC", t, ".csv")
